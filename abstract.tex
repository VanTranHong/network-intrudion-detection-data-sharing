...
(1)Can data sharing improve NIDS?
(2)What kind of data when shared can improve NIDS?
(3)How much data should be shared?
(4)Under what circumstances will data sharing improve NIDS?
